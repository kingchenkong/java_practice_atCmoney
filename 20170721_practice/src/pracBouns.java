			...
			do {
				...
				if (firstHand == 1) {
					...
					do {
						...
						//test
						//						System.out.println("leftNum =" + playerLeftNum + ", != 0? " + (playerLeftNum != 0) + ", %5 != 0? " + (playerLeftNum % 5 != 0) );
						//						System.out.println("punchNum =" + playerRightNum + ", != 0? " + (playerRightNum != 0) + ", %5 != 0? " + (playerRightNum % 5 != 0) );

						//只接受 0, 5, 10,
					} while( (playerLeftNum % 5 != 0) || (playerRightNum % 5 != 0) || (playerLeftNum + playerRightNum > 10) || (playerLeftNum > 5) || (playerRightNum > 5) );
					...
					do {
						...
						//test
//						System.out.println("punchNum =" + punchNum + ", != 0? " + (punchNum != 0) + ", %5 != 0? " + (punchNum % 5 != 0) );
...
//				computerWinRound = 2;
				...
				if (firstHand == 2) {
					...
					System.out.println("computerLRNum = " + computerLRNum + "randomMul = " + randomMul + "randomAdj =" + randomAdj);
