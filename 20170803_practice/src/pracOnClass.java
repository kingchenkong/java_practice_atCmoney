...
public class pracOnClass {
	...
	public static void main(String[] args) {
		...
		//		System.out.println("ASCIICode = " + ASCIICode + " | ASCII2Code = " + ASCII2Char);
		//		
		//		char lowerCaseA = 'a';
		//		int char2ASCIICode = (int) lowerCaseA;
		//		System.out.println("lowerCaseA = " + lowerCaseA + " | char2ASCIICode = " + char2ASCIICode);
		//		longLine("---");
		...
		longLine("###");
		String[] fileNames = {"caterpillar.jp",
				"cater.gif",
				"bushjpg",
				"wuwu.gif.jpg",
				"clockman.jpgif",
